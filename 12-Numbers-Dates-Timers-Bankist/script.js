...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // After timeout, stop timer and logout user
    if (time === 0) {
      clearInterval(timer);
    ...
    // Decrease time by one second every timeout
    time--;
  };

  // Set time to five minutes
  let time = 300; // 300 seconds (5 minutes)
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    // labelDate.textContent = `${mon}/${day}/${year} ${hour}:${min}`;
...
console.log(Number.parseInt('2.5rem')); // Only returns 2
...
console.log(Math.trunc(Math.random() * 6) + 1); // Returns numbers between 1 and 6
...
console.log(6 % 2); // Remainder = 0; 6 is evenly divisible by 2
console.log(6 / 2); // 6 = 2 * 3

console.log(7 % 2); // Remainder = 1; 7 = 2 * 3 + 1
console.log(7 / 2); // 7 is an Odd number and NOT evenly divisible by 2
...
console.log(1234567890123456789012345n);

// Operations with BigInt numbers
console.log(10000n + 10000n);
const huge = 1234567890123456789012345n;
const num = 23;
// console.log(huge * num);   // This operation fails
console.log(huge * BigInt(num)); // This operation does not create an error
...
console.log(new Date(0)); //Gives the start date of the UNIX timestamp
